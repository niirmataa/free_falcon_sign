...
## Explicit source profiles and the next night run
...
This selection does not integrate source into Extra/c. Both profiles use
...
```sh
python3 -B tests/ft1536/dudect/prepare.py --repo "$PWD" --profile floor-ct --defer-timing --work /home/footfalcon/free_falcon_sign/proofs/ft1536/work/FT1536_FPEMU_DUDECT_RUN_002
```
...
At night, after daytime workers/compilers have stopped, the explicit launch
command is:

```sh
python3 -B tests/ft1536/dudect/launch.py /home/footfalcon/free_falcon_sign/proofs/ft1536/work/FT1536_FPEMU_DUDECT_RUN_002
```
...
controls, with an eight-hour global campaign budget; launch preflight is
separate. The selected profile and source pin appear in RUN/RESULT/report.
