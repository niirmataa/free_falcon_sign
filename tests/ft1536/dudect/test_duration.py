...
class DurationChecks(unittest.TestCase):
    ...
    def test_six_and_eight_hour_budget_propagation(self):
        for seconds in (21600,28800):
    ...
    def test_requested_budget_mismatch_stops_before_preflight(self):
        error,calls,receipt,running=self.simulate_launch(21600,requested=28800)
    ...
    def test_fresh_preflight_cannot_silently_restore_eight_hours(self):
        error,calls,receipt,running=self.simulate_launch(21600,requested=21600,fresh_seconds=28800)
    ...
    def test_disk_boundary_prevents_measurements(self):
        self.assertEqual(required_disk_bytes(21600),63552094208)
        error,calls,receipt,running=self.simulate_launch(21600,disk_delta=-1)
    ...
    def test_invalid_preparation_budget_is_rejected_before_filesystem_access(self):
        for seconds in (0,-1,28801,21600.5,True):
