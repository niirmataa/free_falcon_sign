...
theorem norm_sum (a b : Vec) : sumN 4608 (normTerm a b)=Q a b := by
  have hfirst : sumN 3072 (normTerm a b)=
    ...
    calc
      ...
      _ = _ := interleave_sum 1536 (fun i => fromVec a i*fromVec a i) (fun i => fromVec b i*fromVec b i)
  have hlast : sumN 1536 (fun k => normTerm a b (3072+k))=
    ...
    calc
      ...
      _ = _ := interleave_sum 768 (fun i => fromVec a i*fromVec a (i+768)) (fun i => fromVec b i*fromVec b (i+768))
