...
theorem normal_floor_refinement (s : Bool) (e f : Nat) (he0 : 1≤e) (he : e≤1053) (hf : f<4503599627370496) :
  ...
  · rw [ite_eq_right hsmall]
    ...
    rw [hshift,p2_shift]
    cases s <;> simp only [signed,Bool.false_eq_true,↓reduceIte]
    · exact Int.mul_ediv_mul_of_pos _ _ (show (0:Int)<1024 by decide)
    · simpa only [Int.mul_neg] using Int.mul_ediv_mul_of_pos (-mant f) (p2 (1075-e)) (show (0:Int)<1024 by decide)
...
theorem subnormal_floor_refinement (s : Bool) (f : Nat) (hf : f<4503599627370496)
  ...
  · have hne : f≠0 := by intro he;subst f;exact hz ⟨rfl,rfl,rfl⟩
...
theorem negative_zero_exception : floorParts true 0 0= -1 ∧ mathFloor true 0 0=0 := by
  simp [floorParts,mathFloor,signed]
...
theorem negative_zero_sum_still_safe (z : Int) (hz : -365≤z ∧ z≤366) :
    -2147483648≤floorParts true 0 0+z ∧ floorParts true 0 0+z≤2147483647 := by
  rw [negative_zero_exception.1]
  omega
...
#print axioms negative_zero_sum_still_safe
