...
theorem full_map_range (i : Nat) (h : i∈fullMap) : i<18432 := by
  ...
  have all : RawAssembly.All (fun i=>i<18432) fullMap := by
    unfold fullMap
    exact RawAssembly.all_append _ _ _ (hb 3072 (by decide))
      (RawAssembly.all_append _ _ _ (hb 5376 (by decide))
        (RawAssembly.all_append _ _ _ (hb 7680 (by decide))
          (RawAssembly.all_append _ _ _ (hb 11520 (by decide))
            (RawAssembly.all_append _ _ _ (hb 13824 (by decide)) (hb 16128 (by decide))))))
  exact all i h
