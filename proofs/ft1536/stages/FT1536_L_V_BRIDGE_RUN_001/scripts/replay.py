...
def main():
    ...
    for name in ['run.py','check_lean.py','archive_attempt.py','replaylib.py','audit.py','fixtures.py','build_controls.py','native_runs.py','compare_controls.py','toolchain.py']:copy('scripts/'+name)
