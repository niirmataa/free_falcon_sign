...
theorem pull_spec (d : Bytes) (c r : Cursor) (hc : Valid d c) (h : pull d c=some r) :
...
theorem nextBit_empty (d : Bytes) (c : Cursor) (hc : Inv d c) (h : remaining d c=0) : nextBit d c=none := by
...
theorem unary_source (fuel : Nat) (d : Bytes) (ne : Nat) (c : Cursor) (hc : Inv d c)
  ...
  | zero => exact UnaryRun.eof ne c (nextBit_empty d c hc (by omega))
  | succ f ih =>
    rw [unaryFuel]
