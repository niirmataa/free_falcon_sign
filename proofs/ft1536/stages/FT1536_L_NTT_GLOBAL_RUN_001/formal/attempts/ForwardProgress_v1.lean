...
theorem root_coefficients (s : Mem) (i : Nat) (hi : i<768) :
  ...
  constructor
  · simpa only [ha,hb,forwardRootOp,↓reduceIte,hmul,addQ,Int.add_emod,Int.emod_emod] using h0
...
theorem binary_coefficients (h m : Nat) (hh : HalfOK h) (s : Mem) (b : Nat) (hb : b<768) :
  ...
  · rw [pair_stage_at h hh _ s b hb false]
    ...
    simp only [↓reduceIte,mmQ_ordinary,addQ,Int.add_emod,Int.emod_emod]
