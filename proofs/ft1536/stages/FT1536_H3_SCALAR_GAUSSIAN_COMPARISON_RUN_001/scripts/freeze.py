...
with (W/'executor.lock').open('a') as lock:
 ...
 required=['REPORT.md','RESULT.json','CLAIM.md','SCALAR_GAUSSIAN_CERTIFICATE.json','REFERENCE_LAWS.md','REDUCTION_DOMAIN.md','REDUCTION_DOMAIN.json','EXPM_ACCURACY.md','EXPM_ACCURACY.json','CDF_COMPARISON.md','CDF_COMPARISON.json','ERROR_LEDGER.md','ERROR_LEDGER.json','SUPPORT_AND_METRICS.md','NORMALIZATION_BOUND.md','SOURCE_MODEL_BINDING.md','COUNTERMODELS.md','FAILED_ROUTES.md','NEXT_INTERFACE.md','OBLIGATIONS.json','REUSED_RESULTS.md','INPUTS.sha256','TOOLCHAIN.txt','COMMANDS.log','OUTPUT_SCOPE.md','REPLAY.md','SEMANTIC_FILES.json','artifacts/fresh_replay.json']
 for r in required:assert (W/r).is_file(),r
 result=json.loads((W/'RESULT.json').read_text());assert result['game']=='IID_BUFFER' and result['TV_bound_proved'] and result['reverse_chi2']['value']=='infinity' and not result['real_prng_to_iid_bridge_proved']
