# FT1536 — SCALAR_GAUSSIAN_COMPARISON
...
- **FRESH_REPLAY_PASS 516/516**: pełny fresh build bez project
...
Pierwszy fresh DEST zatrzymał się na45-sekundowym timeoutcie `sage --version`,
przed obliczeniami. Pełny failed receipt i późniejszy diagnostic zachowano
w `REPLAY_FAILURES.md` oraz `artifacts/attempts/rehearsal_001/`. Nie ustalono
przyczyny opóźnienia. Bez zmiany recipe,limitów lub inputs drugi,nowy clean DEST
odtworzył516/516; jego rzeczywisty receipt jest sealed jako poprawny replay.
...
SCALAR_GAUSSIAN_CERTIFICATE.json SHA-256: `204b63ba87315ef35eecea608dc7f00c9c2bc400d0bb595512738dd32257ea8c`.
Fresh anchor SHA-256: `3ec48be461deddb1e4a9ba2053c798692dcbad460330e6322522f5ef51d2bc98`.
