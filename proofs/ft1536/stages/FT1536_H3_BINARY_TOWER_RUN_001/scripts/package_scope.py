...
TOP=('AGENTS.md','INDUCTION.md','LEVEL7.md','ASSEMBLY_INTERFACE.md','REPORT.md','RESULT.json','CLAIM.md','TOWER_CERTIFICATE.json',
 'BOUND_LEDGER.json','BOUND_LEDGER.md','OBLIGATIONS.json','NEXT_INTERFACE.md','SOURCE_MODEL_BINDING.md','REUSED_RESULTS.md','INPUTS.sha256','TOOLCHAIN.txt','OUTPUT_SCOPE.md','REPLAY.md')
