...
(W/'artifacts/replay_evidence.json').write_text(json.dumps(dict(copied=len(rows),files=rows,semantic_matches=len(receipt['matches']),note='Full verbatim streams/receipts; analytical proof scope remains explicit.'),indent=2)+'\n')
