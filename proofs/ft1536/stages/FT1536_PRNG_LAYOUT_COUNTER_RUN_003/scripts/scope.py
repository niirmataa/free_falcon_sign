"""Explicit immutable package scope for T02.1, distinct from generated replay semantics."""
import os
from pathlib import Path
EXCLUDED_TOP={'tmp','runtime','cache','bin','.build','executor.lock','COMMANDS.log','OUTPUTS.sha256'}
...
def members(root,anchor=False):
 ...
 return sorted(out)
def seed_file(r):
 if r.startswith(('inputs/','source/','scripts/','harness/','model/','formal/')):return True
 if r in ['TASK.md','SAGEMATH_RULE.md']:return True
