...
TOP=('AGENTS.md','ANALYTIC_PROOF.md','UPSTREAM_REFINEMENT.md','NODE2_FRAME.md','REPORT.md','RESULT.json','CLAIM.md',
 'NODE2_CERTIFICATE.json','BOUND_LEDGER.json','BOUND_LEDGER.md','OBLIGATIONS.json','NEXT_INTERFACE.md',
