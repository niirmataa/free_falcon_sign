...
files.update(['ANALYTIC_PROOF.md','UPSTREAM_REFINEMENT.md','NODE2_FRAME.md','CLAIM.md','NEXT_INTERFACE.md','SOURCE_MODEL_BINDING.md','REUSED_RESULTS.md',
 'NODE2_CERTIFICATE.json','BOUND_LEDGER.json','BOUND_LEDGER.md','OBLIGATIONS.json','TOOLCHAIN.txt'])
...
out=dict(kind='PRE_FREEZE_SEMANTIC_ANCHOR',files=len(files),sha256=sha(W/'artifacts/semantic_manifest.sha256'),
 note='Proof text copied identically, not kernel-certified by copying. Consumed Lean and all new exact/native checks rebuild from sources.')
