...
theorem half_fields (x : Word) (he : ex x≠0) :
  ...
  have hh : (halfC x).val=x.val-4503599627370496 := by rw [half_bits,if_neg he]
  have hw:=x.isLt
  unfold ex at he
  unfold ex frac sg
  rw [hh]
...
theorem parts_error (s : Bool) (e f : Nat) (hf : f<4503599627370496) :
  ...
  cases s <;> simp [halfNum,inputNum,h0,h1,signed,hp,Int.mul_assoc,Int.mul_left_comm,Int.mul_comm]
