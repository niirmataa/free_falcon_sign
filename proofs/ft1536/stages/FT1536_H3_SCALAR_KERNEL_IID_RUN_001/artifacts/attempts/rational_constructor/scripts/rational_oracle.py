...
out=dict(status='PASS_INDEPENDENT_QQ_MASS_AND_CARDINALITY_CONTROLS',game='IID_BUFFER',pmf_examples=len(checks),checks=checks,small_trunc_native_cases=small,low_comparator_reduced_cases=low_checks,limb_reduced_pairs=limb_checks,resources=resources,real_PRNG_executed=False)
