...
fpr_scaled(int64_t i, int sc)
{
 ...
 m = (uint64_t)i;
 e = 9 + sc;
 do { uint32_t nt; (e) -= 63; nt = (uint32_t)((m) >> 32); nt = (nt | -nt) >> 31; (m) ^= ((m) ^ ((m) << 32)) & ((uint64_t)nt - 1); (e) += (int)(nt << 5); nt = (uint32_t)((m) >> 48); nt = (nt | -nt) >> 31; (m) ^= ((m) ^ ((m) << 16)) & ((uint64_t)nt - 1); (e) += (int)(nt << 4); nt = (uint32_t)((m) >> 56); nt = (nt | -nt) >> 31; (m) ^= ((m) ^ ((m) << 8)) & ((uint64_t)nt - 1); (e) += (int)(nt << 3); nt = (uint32_t)((m) >> 60); nt = (nt | -nt) >> 31; (m) ^= ((m) ^ ((m) << 4)) & ((uint64_t)nt - 1); (e) += (int)(nt << 2); nt = (uint32_t)((m) >> 62); nt = (nt | -nt) >> 31; (m) ^= ((m) ^ ((m) << 2)) & ((uint64_t)nt - 1); (e) += (int)(nt << 1); nt = (uint32_t)((m) >> 63); (m) ^= ((m) ^ ((m) << 1)) & ((uint64_t)nt - 1); (e) += (int)(nt); } while (0);
...
fpr_add(fpr x, fpr y)
{
 ...
 do { uint32_t nt; (ex) -= 63; nt = (uint32_t)((xu) >> 32); nt = (nt | -nt) >> 31; (xu) ^= ((xu) ^ ((xu) << 32)) & ((uint64_t)nt - 1); (ex) += (int)(nt << 5); nt = (uint32_t)((xu) >> 48); nt = (nt | -nt) >> 31; (xu) ^= ((xu) ^ ((xu) << 16)) & ((uint64_t)nt - 1); (ex) += (int)(nt << 4); nt = (uint32_t)((xu) >> 56); nt = (nt | -nt) >> 31; (xu) ^= ((xu) ^ ((xu) << 8)) & ((uint64_t)nt - 1); (ex) += (int)(nt << 3); nt = (uint32_t)((xu) >> 60); nt = (nt | -nt) >> 31; (xu) ^= ((xu) ^ ((xu) << 4)) & ((uint64_t)nt - 1); (ex) += (int)(nt << 2); nt = (uint32_t)((xu) >> 62); nt = (nt | -nt) >> 31; (xu) ^= ((xu) ^ ((xu) << 2)) & ((uint64_t)nt - 1); (ex) += (int)(nt << 1); nt = (uint32_t)((xu) >> 63); (xu) ^= ((xu) ^ ((xu) << 1)) & ((uint64_t)nt - 1); (ex) += (int)(nt); } while (0);
