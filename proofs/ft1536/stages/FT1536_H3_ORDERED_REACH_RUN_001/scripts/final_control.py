...
if mode=='replay':
 ...
 print(json.dumps(dict(standard_replay='PASS',claim_status='PARTIAL_PROOF',semantic_matches=child['semantic_matches'],receipt=str(D/'replay/REPLAY_RESULT.json')),indent=2))
