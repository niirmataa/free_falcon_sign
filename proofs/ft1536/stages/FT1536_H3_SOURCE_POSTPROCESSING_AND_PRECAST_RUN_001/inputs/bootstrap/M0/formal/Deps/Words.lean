...
theorem mont_ranges (z : Int) (hz0 : 0 ≤ z) (hz1 : z ≤ 339738624) :
  ...
  have hl : 0 ≤ montLow z ∧ montLow z ≤ 65535 := by
    unfold montLow low16 u32
    omega
  have hw : 0 ≤ montLow z*18433 ∧ montLow z*18433 ≤ 1208006655 := by omega
  have hs : 0 ≤ z+montLow z*18433 ∧ z+montLow z*18433 ≤ 1547745279 := by omega
  have wexact : u32 (montLow z*18433) = montLow z*18433 := by unfold u32; omega
  have sexact : u32 (z+montLow z*18433) = z+montLow z*18433 := by unfold u32; omega
  unfold montShift
  rw [wexact, sexact]
  omega
...
theorem mq_montymul_contract (x y : Nat) (hx : x < 18433) (hy : y < 18433) :
  ...
  have h0 : (0 : Int) ≤ Int.ofNat (x*y) := Int.natCast_nonneg (x*y)
  have h1 : Int.ofNat (x*y) ≤ 339738624 := Int.ofNat_le.mpr h
  exact mont_contract_z (Int.ofNat (x*y)) h0 h1
