...
-- Euclidean quotient equals C99 truncation here, since shifted x is positive.
...
theorem positive_remainder (t : Int) (ht : 0 ≤ t) :
...
-- Componentwise vector contract; the returned second component is the same s.
