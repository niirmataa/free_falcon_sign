...
TOP=('AGENTS.md','ANALYTIC_PROOF.md','EMITTED_BINDING.md','ROOT_FRAME.md','REPORT.md','RESULT.json','CLAIM.md',
 'ROOT_CERTIFICATE.json','BOUND_LEDGER.json','BOUND_LEDGER.md','OBLIGATIONS.json','NEXT_INTERFACE.md',
