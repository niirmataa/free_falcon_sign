# V19 — Pełne history-dependent observed byte kernels jednego Sign call — niezależna weryfikacja

Autor projektu Niirmata. Pakiet B20_001,2026-09-22. Rola: RECENZENT.
ROADMAP_ID=T06. TASK_ID=B20_001_V19_COMPLETE_OBSERVED_KERNELS. Para=P19.
...
W=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V19
IN=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V19/inputs
RUN=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V19/run
OUTPUT_DIR=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V19/output
CHECKPOINTS=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V19/checkpoints
CHECKOUT=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V19/checkout
BRANCH=proof/b20/v19
CHECKPOINT_PREFIX=B20_001_V19_CP
FINAL_STAGE=B20_001_V19_FINAL_001
INPUT_CONTRACT=/home/footfalcon/free_falcon_sign/proofs/ft1536/batches/B20_001/reviews/V19/INPUT_CONTRACT.json
```
...
Sam zapisujesz milestones jako niirmataa na **proof/b20/v19**,we własnym CHECKOUT.
...
Allowlist: `proofs/ft1536/stages/B20_001_V19_CP*/`,
`proofs/ft1536/stages/B20_001_V19_FINAL_001/`,odpowiadające catalog JSON
...
Następny consumer i przypięte zależności są w INDEX.json; ten Vxx kończy odbiór P19.

## 9. Twoja niezależna weryfikacja P19

Odbierasz dokładnie P19,nie poprzedni podobny run. Twoje podstawowe pytanie:
**Prześledź każdy outcome i transition boundary,common key law oraz metric composition. Brakujące P10/P16/P18 instancje nie mogą być ukryte w interface type.**
