...
ROADMAP_ID=F03–F06; formalny primitive/source binding. TASK_ID=B20_001_V02_WORD_FPEMU_REFINEMENT. Para=P02.
...
IN=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V02/inputs
RUN=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V02/run
OUTPUT_DIR=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V02/output
CHECKPOINTS=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V02/checkpoints
CHECKOUT=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V02/checkout
BRANCH=proof/b20/v02
CHECKPOINT_PREFIX=B20_001_V02_CP
FINAL_STAGE=B20_001_V02_FINAL_001
INPUT_CONTRACT=/home/footfalcon/free_falcon_sign/proofs/ft1536/batches/B20_001/reviews/V02/INPUT_CONTRACT.json
```
...
Sam zapisujesz milestones jako niirmataa na **proof/b20/v02**,we własnym CHECKOUT.
...
Allowlist: `proofs/ft1536/stages/B20_001_V02_CP*/`,
`proofs/ft1536/stages/B20_001_V02_FINAL_001/`,odpowiadające catalog JSON
...
Następny consumer i przypięte zależności są w INDEX.json; ten Vxx kończy odbiór P02.

## 9. Twoja niezależna weryfikacja P02

Odbierasz dokładnie P02,nie poprzedni podobny run. Twoje podstawowe pytanie:
**Sprawdź równoważność literalnych operatorów C i modelu,pełność domen oraz każdy assumed caller range. Dobre fixtures nie zastępują all-word/domain theorem.**
