# V14 — Formalna adaptacyjna kompozycja3072 calls jednego root — niezależna weryfikacja

Autor projektu Niirmata. Pakiet B20_001,2026-09-22. Rola: RECENZENT.
ROADMAP_ID=F08 formal debt; T05. TASK_ID=B20_001_V14_ORDERED_JOINT_KERNEL. Para=P14.
...
W=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V14
IN=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V14/inputs
RUN=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V14/run
OUTPUT_DIR=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V14/output
CHECKPOINTS=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V14/checkpoints
CHECKOUT=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V14/checkout
BRANCH=proof/b20/v14
CHECKPOINT_PREFIX=B20_001_V14_CP
FINAL_STAGE=B20_001_V14_FINAL_001
INPUT_CONTRACT=/home/footfalcon/free_falcon_sign/proofs/ft1536/batches/B20_001/reviews/V14/INPUT_CONTRACT.json
```
...
Zależności dowodowe Pxx: **P01, P08, P09, P12, P13**. Stałe materiały: **JOINT, LEFT, POST**,
...
Dowieść actual ordered root law,joint innovations/returns/byte tape oraz reference exits i directed comparison w pełnym kernelowym łańcuchu.

- B20.Joint.source_order_and_reach : every positive source prefix → next legal call or specified exit
- B20.Joint.root_kernel_composition : actual3072 adaptive calls = composed conditional scalar kernels
- B20.Joint.directed_bounds : correctly typed TV/chi2 comparisons for Q_S and Q_stop
- B20.Joint.proposal_resource_tail : E[T]≤24576 and Pr[T>49152]<2^-1024,if certified
...
- Zachowaj literal paired/cubic/binary/root order i history-dependent centers/widths.
- Pokaż source-law applicability na KAŻDYM osiągniętym prefixie; nie zakładaj niezależnych Y lub future success.
- Q_S,Q_stop i exit tags mają osobne definicje. Q_S nie jest automatycznie Q_stop conditioned on survival.
- Formalize product/kernel change-of-measure i cumulative losses wraz z support cost.
- Resource tail i mean mają uwzględniać stopping/rejection,a nie ghost runtime caps.

## 5. Kontrole i próby ujemne

- Wrong call order,omitted exit mass,conditioning-on-survival i reused-unread-tape mutations.
- Exact finite toy kernels do niezależnego sprawdzenia orientation.
- Konsumpcja P09 domains i P12 fresh-tail exports sprawdzana po typach.
...
Sam zapisujesz milestones jako niirmataa na **proof/b20/v14**,we własnym CHECKOUT.
...
Allowlist: `proofs/ft1536/stages/B20_001_V14_CP*/`,
`proofs/ft1536/stages/B20_001_V14_FINAL_001/`,odpowiadające catalog JSON
...
One-root IID law; pełny API/retry/real randomness to osobne consumer lemmas.
...
Następny consumer i przypięte zależności są w INDEX.json; ten Vxx kończy odbiór P14.

## 9. Twoja niezależna weryfikacja P14

Odbierasz dokładnie P14,nie poprzedni podobny run. Twoje podstawowe pytanie:
**Zweryfikuj całe history-dependent composition,nie tylko generic product theorem. Każdy constant/loss musi być rzeczywiście zinstancjowany.**
