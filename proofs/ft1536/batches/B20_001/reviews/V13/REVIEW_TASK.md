# V13 — Formalny directed TV/χ² scalar comparison i support — niezależna weryfikacja

Autor projektu Niirmata. Pakiet B20_001,2026-09-22. Rola: RECENZENT.
ROADMAP_ID=F07 formal debt; T05. TASK_ID=B20_001_V13_GAUSSIAN_COMPARISON_KERNEL. Para=P13.
...
W=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V13
IN=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V13/inputs
RUN=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V13/run
OUTPUT_DIR=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V13/output
CHECKPOINTS=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V13/checkpoints
CHECKOUT=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V13/checkout
BRANCH=proof/b20/v13
CHECKPOINT_PREFIX=B20_001_V13_CP
FINAL_STAGE=B20_001_V13_FINAL_001
INPUT_CONTRACT=/home/footfalcon/free_falcon_sign/proofs/ft1536/batches/B20_001/reviews/V13/INPUT_CONTRACT.json
```
...
Zależności dowodowe Pxx: **P01, P12**. Stałe materiały: **GAUSS, SCALAR**,
...
Dowieść w kernelu uniform porównanie source scalar IID kernel z dokładnie zdefiniowanym dyskretnym Gaussianem,z normalizerami,ogonami i poprawnym kierunkiem miary.

- B20.Gaussian.normalizer_and_tail_certificates : uniform legal μ/σ → checked bounds on infinite sums
- B20.Gaussian.scalar_TV : TV(K_C,G)≤2^-36,jeśli pełny certyfikat to wykaże
- B20.Gaussian.scalar_forward_chi2 : χ²(K_C||G)≤2^-60,jeśli osiągalne w required domain
- B20.Gaussian.reverse_support_obstruction : G on Z versus finite K support gives stated reverse obstruction
...
- Zdefiniuj G z actual parameter words i właściwą normalizacją,nie przez nominalne σ bez source mapping.
- Sprawdź wszystkie zakresy center,width,tailcut i clipped support uniformnie.
- Sage ma wygenerować rational/Taylor/interval certificates; formal consumer dowodzi ich znaczenia dla exp/sum/tail.
- TV2^-36 i forwardχ²2^-60 są historycznymi celami do formalnego wykazania,nie przesłankami.
- Rozlicz zero mass,absolute continuity i reverse∞; nie zamień kierunku divergence przy kompozycji.

## 5. Kontrole i próby ujemne

- Wrong divergence direction,missing normalizer i support mutation.
- Boundary parameter words i negative-zero cases.
- Złe endpointy lub ucięty tail certificate muszą odpaść w Lean.
...
Sam zapisujesz milestones jako niirmataa na **proof/b20/v13**,we własnym CHECKOUT.
...
Allowlist: `proofs/ft1536/stages/B20_001_V13_CP*/`,
`proofs/ft1536/stages/B20_001_V13_FINAL_001/`,odpowiadające catalog JSON
...
Jeśli budżety historyczne nie przechodzą,oddaj udowodnione boundy z PARTIAL; nie powiększaj ich po cichu w consumerze.
...
Następny consumer i przypięte zależności są w INDEX.json; ten Vxx kończy odbiór P13.

## 9. Twoja niezależna weryfikacja P13

Odbierasz dokładnie P13,nie poprzedni podobny run. Twoje podstawowe pytanie:
**Czy formal proof dotyczy wszystkich legal words,a nie skończonej siatki? Czy sumy nieskończone i tails są dowiedzione,nie przypisane Sage jako aksjomat?**
