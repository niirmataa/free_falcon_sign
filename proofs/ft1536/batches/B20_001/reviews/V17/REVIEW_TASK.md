# V17 — Formalny checked-precast observer,norm i byte codec — niezależna weryfikacja

Autor projektu Niirmata. Pakiet B20_001,2026-09-22. Rola: RECENZENT.
ROADMAP_ID=F06 + T06. TASK_ID=B20_001_V17_PRECAST_CODEC_REFINEMENT. Para=P17.
...
W=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V17
IN=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V17/inputs
RUN=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V17/run
OUTPUT_DIR=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V17/output
CHECKPOINTS=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V17/checkpoints
CHECKOUT=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V17/checkout
BRANCH=proof/b20/v17
CHECKPOINT_PREFIX=B20_001_V17_CP
FINAL_STAGE=B20_001_V17_FINAL_001
INPUT_CONTRACT=/home/footfalcon/free_falcon_sign/proofs/ft1536/batches/B20_001/reviews/V17/INPUT_CONTRACT.json
```
...
Zależności dowodowe Pxx: **P01, P02, P11, P15**. Stałe materiały: **POST, T01, M0, LV**,
...
Dowieść source postprocessing/codec semantics oraz equality-until-bad checked-precast coupling dla actual observed bytes,bez założenia uniwersalnego Safe16.

- B20.Bytes.wide_narrow_stored_refinement : exact source cast/order and stored norm semantics
- B20.Bytes.equal_until_bad : shared execution outside joint BadPrecast → same source/checked public outcome
- B20.Bytes.static_codec_roundtrip_and_capacity : norm-accepted stored pair → correct STATIC bytes and payload≤3160
- B20.Bytes.public_projection_bound : proved event coupling → observable-kernel bound
...
- Formalize iFFT/rint/narrowing,implementation-defined casts under pinned ABI,source norm order,fault and encode failure outcomes.
- Wide integers i stored int16 są różnymi obiektami; nie wyprowadzaj Safe16 z późniejszego stored norm.
- Prove capacity/header/length/padding and decode roundtrip for actual STATIC producer; nonce40 osobno.
- Ghost PRECAST_EXIT nie jest nowym C abortem; define observations so source behavior is preserved until bad.
- Use P15 for probability,not an assumed deterministic no-bad premise to claim full safety.

## 5. Kontrole i próby ujemne

- Cast overflow,header/capacity boundary,negative values,padding and wrong-buffer mutations.
- No-op ghost observation and actual source error returns.
- C slices with sanitizers plus kernel-definedness/application proof.
...
Sam zapisujesz milestones jako niirmataa na **proof/b20/v17**,we własnym CHECKOUT.
...
Allowlist: `proofs/ft1536/stages/B20_001_V17_CP*/`,
`proofs/ft1536/stages/B20_001_V17_FINAL_001/`,odpowiadające catalog JSON
...
Congruence/recovery i verifier centering pozostają celami P10/P18; codec roundtrip sam ich nie zapewnia.
...
Następny consumer i przypięte zależności są w INDEX.json; ten Vxx kończy odbiór P17.

## 9. Twoja niezależna weryfikacja P17

Odbierasz dokładnie P17,nie poprzedni podobny run. Twoje podstawowe pytanie:
**Sprawdź moment obserwacji przed stores,pełny memory/frame i codec refinement. Uniform Safe16 nie może zostać dopisane jako wygodne założenie.**
