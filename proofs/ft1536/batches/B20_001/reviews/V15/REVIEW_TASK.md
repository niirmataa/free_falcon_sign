# V15 — Kernelowy H6 tail i zatrzymana kompozycja cap16 — niezależna weryfikacja

Autor projektu Niirmata. Pakiet B20_001,2026-09-22. Rola: RECENZENT.
ROADMAP_ID=F09 + T01 formal debt. TASK_ID=B20_001_V15_H6_RETRY_FORMAL_COMPOSITION. Para=P15.
...
W=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V15
IN=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V15/inputs
RUN=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V15/run
OUTPUT_DIR=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V15/output
CHECKPOINTS=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V15/checkpoints
CHECKOUT=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V15/checkout
BRANCH=proof/b20/v15
CHECKPOINT_PREFIX=B20_001_V15_CP
FINAL_STAGE=B20_001_V15_FINAL_001
INPUT_CONTRACT=/home/footfalcon/free_falcon_sign/proofs/ft1536/batches/B20_001/reviews/V15/INPUT_CONTRACT.json
```
...
Sam zapisujesz milestones jako niirmataa na **proof/b20/v15**,we własnym CHECKOUT.
...
Allowlist: `proofs/ft1536/stages/B20_001_V15_CP*/`,
`proofs/ft1536/stages/B20_001_V15_FINAL_001/`,odpowiadające catalog JSON
...
Następny consumer i przypięte zależności są w INDEX.json; ten Vxx kończy odbiór P15.

## 9. Twoja niezależna weryfikacja P15

Odbierasz dokładnie P15,nie poprzedni podobny run. Twoje podstawowe pytanie:
**Czy zarówno probability theorem,jak actual source instancja i scheduler są formalne? Sprawdź pełny directed loss/event ownership i wspólne budget event.**
