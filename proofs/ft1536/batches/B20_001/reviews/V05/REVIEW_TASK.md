# V05 — Formalny computational hop real SHAKE/ChaCha → skończony widok IID — niezależna weryfikacja

Autor projektu Niirmata. Pakiet B20_001,2026-09-22. Rola: RECENZENT.
ROADMAP_ID=T02. TASK_ID=B20_001_V05_REAL_RNG_GAME_BRIDGE. Para=P05.
...
W=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V05
IN=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V05/inputs
RUN=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V05/run
OUTPUT_DIR=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V05/output
CHECKPOINTS=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V05/checkpoints
CHECKOUT=/home/footfalcon/free_falcon_sign
BRANCH=main
FINAL_STAGE=B20_001_V05_FINAL_001
INPUT_CONTRACT=/home/footfalcon/free_falcon_sign/proofs/ft1536/batches/B20_001/reviews/V05/INPUT_CONTRACT.json
```
...
Allowlist po odbiorze: `proofs/ft1536/stages/B20_001_V05_FINAL_*/`,odpowiadające catalog JSON
...
Następny consumer i przypięte zależności są w INDEX.json; ten Vxx kończy odbiór P05.

## 9. Twoja niezależna weryfikacja P05

Odbierasz dokładnie P05,nie poprzedni podobny run. Twoje podstawowe pytanie:
**Czy theorem jest rzeczywistą redukcją z właściwym oracle access,metric i resource bounds? Weryfikuj named assumptions i brak ukrytej tezy IID/desired loss.**
