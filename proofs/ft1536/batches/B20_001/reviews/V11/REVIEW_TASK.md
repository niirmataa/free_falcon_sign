# V11 — Formalny prefix API,nonce/H2P i wejście ReadyRetryEntry — niezależna weryfikacja

Autor projektu Niirmata. Pakiet B20_001,2026-09-22. Rola: RECENZENT.
ROADMAP_ID=T04. TASK_ID=B20_001_V11_PREFIX_API_BINDING. Para=P11.
...
W=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V11
IN=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V11/inputs
RUN=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V11/run
OUTPUT_DIR=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V11/output
CHECKPOINTS=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V11/checkpoints
CHECKOUT=/home/footfalcon/free_falcon_sign/proofs/ft1536/work/B20_001/V11/checkout
BRANCH=proof/b20/v11
CHECKPOINT_PREFIX=B20_001_V11_CP
FINAL_STAGE=B20_001_V11_FINAL_001
INPUT_CONTRACT=/home/footfalcon/free_falcon_sign/proofs/ft1536/batches/B20_001/reviews/V11/INPUT_CONTRACT.json
```
...
Sam zapisujesz milestones jako niirmataa na **proof/b20/v11**,we własnym CHECKOUT.
...
Allowlist: `proofs/ft1536/stages/B20_001_V11_CP*/`,
`proofs/ft1536/stages/B20_001_V11_FINAL_001/`,odpowiadające catalog JSON
...
Następny consumer i przypięte zależności są w INDEX.json; ten Vxx kończy odbiór P11.

## 9. Twoja niezależna weryfikacja P11

Odbierasz dokładnie P11,nie poprzedni podobny run. Twoje podstawowe pytanie:
**Czy ReadyRetryEntry wynika z rzeczywistego prefixu,a nie z definicji zawierającej cel? Czy public H2P i private PRNG mają różne,jasne interfejsy?**
