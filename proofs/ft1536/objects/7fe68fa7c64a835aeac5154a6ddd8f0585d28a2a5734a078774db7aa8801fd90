...
for name,extra in [('map',['source/falcon-fft.c']),('post',['source/shake.c'])]:
 ...
 t=time.monotonic();p=subprocess.run(cmd,capture_output=True,timeout=120);tag='build_'+mode+'_'+name
