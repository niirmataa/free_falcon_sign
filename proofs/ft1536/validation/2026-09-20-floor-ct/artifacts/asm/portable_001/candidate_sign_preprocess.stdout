# 0 "candidate/source/falcon-sign.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "candidate/source/falcon-sign.c"
# 32 "candidate/source/falcon-sign.c"
# 1 "candidate/source/internal.h" 1
# 36 "candidate/source/internal.h"
...
# 37 "candidate/source/internal.h" 2
...
# 38 "candidate/source/internal.h" 2

# 1 "candidate/source/shake.h" 1
# 41 "candidate/source/shake.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/14/include/stddef.h" 1 3 4
# 145 "/usr/lib/gcc/x86_64-linux-gnu/14/include/stddef.h" 3 4
typedef long int ptrdiff_t;
# 42 "candidate/source/shake.h" 2
...
# 43 "candidate/source/shake.h" 2
# 81 "candidate/source/shake.h"
...
# 40 "candidate/source/internal.h" 2
# 1 "candidate/source/falcon.h" 1
# 35 "candidate/source/falcon.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/14/include/stddef.h" 1 3 4
# 36 "candidate/source/falcon.h" 2
# 84 "candidate/source/falcon.h"
...
# 208 "candidate/source/internal.h"
int falcon_complete_private(int16_t *G,
 const int16_t *f, const int16_t *g, const int16_t *F,
 unsigned logn, int ternary);
# 296 "candidate/source/internal.h"
# 1 "candidate/source/fpr-emulated.h" 1
# 14 "candidate/source/fpr-emulated.h"
...
# 15 "candidate/source/fpr-emulated.h" 2


# 16 "candidate/source/fpr-emulated.h"
...
# 297 "candidate/source/internal.h" 2
# 316 "candidate/source/internal.h"
void falcon_FFT(fpr *f, unsigned logn);
# 326 "candidate/source/internal.h"
...
# 344 "candidate/source/internal.h"
...
# 367 "candidate/source/internal.h"
void falcon_poly_neg(fpr *a, unsigned logn);
# 378 "candidate/source/internal.h"
...
# 438 "candidate/source/internal.h"
...
void falcon_poly_divadj_fft(fpr *restrict a,
 const fpr *restrict b, unsigned logn);
# 461 "candidate/source/internal.h"
...
# 529 "candidate/source/internal.h"
void falcon_FFT3(fpr *f, unsigned logn, unsigned full);
# 540 "candidate/source/internal.h"
...
# 559 "candidate/source/internal.h"
...
# 651 "candidate/source/internal.h"
...
void falcon_poly_divadj_fft3(fpr *restrict a,
 const fpr *restrict b, unsigned logn, unsigned full);
# 675 "candidate/source/internal.h"
...
void falcon_poly_merge_deep_fft3(fpr *restrict f,
 const fpr *restrict f0, const fpr *restrict f1, unsigned logn);
# 757 "candidate/source/internal.h"
int falcon_get_seed(void *seed, size_t seed_len);
# 767 "candidate/source/internal.h"
typedef struct {
 union {
...
# 797 "candidate/source/internal.h"
...
# 851 "candidate/source/internal.h"
}
...
# 33 "candidate/source/falcon-sign.c" 2
# 117 "candidate/source/falcon-sign.c"
# 1 "candidate/source/ft1536-adaptive-cdf-tables.h" 1
# 15 "candidate/source/ft1536-adaptive-cdf-tables.h"
...
# 118 "candidate/source/falcon-sign.c" 2
# 293 "candidate/source/falcon-sign.c"
static void
...
{
# 344 "candidate/source/falcon-sign.c"
 return (logn + 1) << logn;
}
# 354 "candidate/source/falcon-sign.c"
static void
...
# 404 "candidate/source/falcon-sign.c"
static void
...
# 504 "candidate/source/falcon-sign.c"
static void
...
# 547 "candidate/source/falcon-sign.c"
static void
 ...
 unsigned logn, fpr *restrict tmp)
{
 ...
 if (logn == 1) {
# 620 "candidate/source/falcon-sign.c"
...
# 690 "candidate/source/falcon-sign.c"
 falcon_poly_split_deep_fft3(t0, t1, g00, logn);
 falcon_poly_adj_fft3(t1, logn - 1, 0);
 s += ffLDL_inner_fft3(tree + s, t0, t1, t0, logn - 1, t2);
 ...
 unsigned logn, fpr *restrict tmp)
{
 ...
 t2 = t1 + tn;
 t3 = t2 + tn;
# 732 "candidate/source/falcon-sign.c"
...
# 963 "candidate/source/falcon-sign.c"
static size_t
 ...
 const fpr *leaves, size_t *leaf_index)
{
 ...
 if (logn == 1) {
# 987 "candidate/source/falcon-sign.c"
...
# 1158 "candidate/source/falcon-sign.c"
static int
...
# 1217 "candidate/source/falcon-sign.c"
 if (ter) {
  fpr *g00, *g10, *g11, *gxx;
  fpr *stable_leaves;
...
# 1563 "candidate/source/falcon-sign.c"
static void
...
# 1848 "candidate/source/falcon-sign.c"
static void
 ...
 unsigned logn, unsigned ter, fpr *restrict tmp)
{
 ...
 if (ter) {
  ...
  for (u = 0; u < n; u ++) {
# 1931 "candidate/source/falcon-sign.c"
  ...
  for (u = 0; u < n; u ++) {
# 1985 "candidate/source/falcon-sign.c"
...
# 2236 "candidate/source/falcon-sign.c"
typedef struct {
 uint64_t hi, lo;
} z128;
...
# 2286 "candidate/source/falcon-sign.c"
static int
...
# 2329 "candidate/source/falcon-sign.c"
...
# 2468 "candidate/source/falcon-sign.c"
static int
BerExp(prng *p, fpr x)
{
 int s;
...
# 2522 "candidate/source/falcon-sign.c"
static int
sampler(void *ctx, fpr mu, fpr sigma)
{
 ...
 p = ctx;
# 2542 "candidate/source/falcon-sign.c"
 s = fpr_floor(mu);
 ...
 for (;;) {
  int z, b;
  fpr x;
# 2568 "candidate/source/falcon-sign.c"
  z = gaussian0_sampler(p);
  b = falcon_prng_get_u8(p) & 1;
  z = b + ((b << 1) - 1) * z;
# 2593 "candidate/source/falcon-sign.c"
...
# 2732 "candidate/source/falcon-sign.c"
static uint64_t
...
# 2790 "candidate/source/falcon-sign.c"
static int
...
# 2840 "candidate/source/falcon-sign.c"
static int
...
# 2898 "candidate/source/falcon-sign.c"
 for (;;) {
  int z, b;
  fpr x;
...
# 2953 "candidate/source/falcon-sign.c"
...
# 3016 "candidate/source/falcon-sign.c"
static void
...
{
 if (fs->sk != 
# 3052 "candidate/source/falcon-sign.c" 3 4
              ((void *)0)
# 3052 "candidate/source/falcon-sign.c"
                  ) {
  ...
  free(fs->sk);
  fs->sk = 
# 3057 "candidate/source/falcon-sign.c" 3 4
          ((void *)0)
# 3057 "candidate/source/falcon-sign.c"
              ;
  fs->sk_len = 0;
 }
 if (fs->tmp != 
# 3060 "candidate/source/falcon-sign.c" 3 4
               ((void *)0)
# 3060 "candidate/source/falcon-sign.c"
                   ) {
  ...
  free(fs->tmp);
  fs->tmp = 
# 3065 "candidate/source/falcon-sign.c" 3 4
           ((void *)0)
# 3065 "candidate/source/falcon-sign.c"
               ;
  fs->tmp_len = 0;
 }
 fs->q = 0;
...
falcon_sign_new(void)
{
 ...
 fs = malloc(sizeof *fs);
 if (fs == 
# 3080 "candidate/source/falcon-sign.c" 3 4
          ((void *)0)
# 3080 "candidate/source/falcon-sign.c"
              ) {
  return 
# 3081 "candidate/source/falcon-sign.c" 3 4
        ((void *)0)
# 3081 "candidate/source/falcon-sign.c"
            ;
 }
 fs->seeded = 0;
 fs->flipped = 0;
 ...
 fs->ternary = 0;
 fs->sk = 
# 3088 "candidate/source/falcon-sign.c" 3 4
         ((void *)0)
# 3088 "candidate/source/falcon-sign.c"
             ;
 fs->sk_len = 0;
 fs->tmp = 
# 3090 "candidate/source/falcon-sign.c" 3 4
          ((void *)0)
# 3090 "candidate/source/falcon-sign.c"
              ;
 fs->tmp_len = 0;
...
{
 if (fs != 
# 3100 "candidate/source/falcon-sign.c" 3 4
          ((void *)0)
# 3100 "candidate/source/falcon-sign.c"
              ) {
  clear_private(fs);
  free(fs);
 }
 ...
 const void *skey, size_t len)
{
 ...
 int i;
 int fb, has_G;
# 3167 "candidate/source/falcon-sign.c"
 clear_private(fs);
 if (skey == 
# 3168 "candidate/source/falcon-sign.c" 3 4
            ((void *)0) 
# 3168 "candidate/source/falcon-sign.c"
                 || len < 1) {
  goto bad_skey;
 }
# 3190 "candidate/source/falcon-sign.c"
 skey_buf = skey;
 fb = *skey_buf ++;
 len --;
 fs->logn = fb & 0x0F;
 ...
 if (fs->sk == 
# 3252 "candidate/source/falcon-sign.c" 3 4
              ((void *)0)
# 3252 "candidate/source/falcon-sign.c"
                  ) {
  goto bad_skey;
 }
 fs->tmp = malloc(fs->tmp_len);
 if (fs->tmp == 
# 3256 "candidate/source/falcon-sign.c" 3 4
               ((void *)0)
# 3256 "candidate/source/falcon-sign.c"
                   ) {
  goto bad_skey;
 }
...
falcon_sign_generate(falcon_sign *fs, void *sig, size_t sig_max_len, int comp)
{
 ...
 if (fs->sk == 
# 3315 "candidate/source/falcon-sign.c" 3 4
              ((void *)0)
# 3315 "candidate/source/falcon-sign.c"
                  ) {
  return 0;
 }
 if (!rng_ready(fs)) {
...
# 3346 "candidate/source/falcon-sign.c"
  prng p;
  ternary_sampler_context tsc;
  samplerZ samp;
  void *samp_ctx;
...
# 3385 "candidate/source/falcon-sign.c"
  {
   int short_ok;

   short_ok = falcon_is_short(s1, s2, fs->logn, fs->ternary);
# 3402 "candidate/source/falcon-sign.c"
   if (short_ok) {
    break;
   }
