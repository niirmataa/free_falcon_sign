...
# candidate/source/fpr-emulated.h:133: 	xi = (int64_t)(((uint64_t)xi & ~mask) | ((-t) & mask));
	leaq	-1(%rdx), %rcx	#, _34
	andq	%rcx, %rax	# _34, _36
# candidate/source/fpr-emulated.h:133: 	xi = (int64_t)(((uint64_t)xi & ~mask) | ((-t) & mask));
	negq	%rdx	# tmp149
	andq	%rdx, %rsi	# tmp149, _38
# candidate/source/fpr-emulated.h:133: 	xi = (int64_t)(((uint64_t)xi & ~mask) | ((-t) & mask));
	orq	%rsi, %rax	# _38, _39
...
# candidate/source/fpr-emulated.h:260: 	x1 = (uint32_t)(x >> 32);
	movq	%rdi, %r8	# z, _44
	shrq	$32, %r8	#, _44
	leaq	8+fpr_expm_p63_coefficients(%rip), %rsi	#, ivtmp.56
	leaq	96(%rsi), %r9	#, _62
